...
oUF:Factory(function(self)
	...
	local pets = {}
		...
		pets[1]:SetPoint('BOTTOMLEFT', party, 'TOPLEFT', (TukuiCF["panels"].tinfowidth / 5) - 4.3 + 5, 7) 
		pets[1]:SetSize((TukuiCF["panels"].tinfowidth / 5) - 2.5, 20)
	for i =2, 4 do 
		pets[i] = oUF:Spawn('partypet'..i, 'oUF_TukuiPartyPet'..i) 
		pets[i]:SetPoint('TOPLEFT', pets[i-1], 'TOPRIGHT', 3, 0) 
		pets[i]:SetSize((TukuiCF["panels"].tinfowidth / 5) - 2.5, 20)
	end
