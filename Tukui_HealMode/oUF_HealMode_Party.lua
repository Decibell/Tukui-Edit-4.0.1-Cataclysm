...
local function Shared(self, unit)
	...
	if unitframes.health_deficit and not unit:find("partypet") then hs = 6 end
	...
	if unitframes.health_deficit and not unit:find("partypet") then
...
oUF:RegisterStyle('TukuiHealModeParty', Shared)
oUF:Factory(function(self)
	oUF:SetActiveStyle("TukuiHealModeParty")

	local party = self:SpawnHeader("oUF_TukuiHealModeParty", nil, "solo,party", 
	...
	party:SetPoint("BOTTOM", UIParent, "BOTTOM", 0, TukuiDB.Scale(169))
	
	local pets = {}
		pets[1] = oUF:Spawn('partypet1', 'oUF_TukuiPartyPet1') 
		pets[1]:SetPoint('BOTTOMLEFT', party, 'TOPLEFT', 70, 7) 
		pets[1]:SetSize(70, 20)
	for i =2, 4 do 
		pets[i] = oUF:Spawn('partypet'..i, 'oUF_TukuiPartyPet'..i) 
		pets[i]:SetPoint('TOPLEFT', pets[i-1], 'TOPRIGHT', 3, 0) 
		pets[i]:SetSize(70, 20)
	end
