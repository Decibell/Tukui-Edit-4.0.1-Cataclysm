if not TukuiCF["unitframes"].enable == true or IsAddOnLoaded("ecUnitframes") then return end
...
player:SetPoint("BOTTOM", UIParent, "BOTTOM", TukuiDB.Scale(-300), TukuiDB.Scale(167))
...
target:SetPoint("BOTTOM", UIParent, "BOTTOM", TukuiDB.Scale(300), TukuiDB.Scale(167))
