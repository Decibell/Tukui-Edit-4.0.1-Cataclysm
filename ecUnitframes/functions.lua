...
do
	...
	function TukuiDB.PostCreateAura(element, button)
		...
		button.remaining = TukuiDB.SetFontString(button, TukuiCF["media"].pixelfont, 8, "MONOCHROMEOUTLINE")
		...
		button.count:SetFont(TukuiCF["media"].pixelfont, 8, "MONOCHROMEOUTLINE")
