...
function Stuffing:SlotUpdate(b)
	...
	scount:SetFont (BAGSFONT, 12, "OUTLINE")
	scount:SetPoint("BOTTOMRIGHT", -1, 2)
	b.scount = scount
...
function Stuffing:CreateBagFrame(w)
	...
	f.b_close:SetWidth(TukuiDB.Scale(35))
	...
	f.b_text:SetFont(TukuiCF["media"].font, 12)
	...
	if w == "Bags" then
		...
		f.b_key:SetWidth(TukuiDB.Scale(45))
		...
		f.b_ktext:SetFont(TukuiCF["media"].font, 12)
		f.b_ktext:SetPoint("CENTER", 0, 0)
...
function Stuffing:InitBags()
	...
	gold:SetPoint("RIGHT", f.b_key, "LEFT", TukuiDB.Scale(-5), 0)
...
function Stuffing:Layout(lb)
	...
	if lb then
		...
		f.detail:SetPoint("RIGHT", TukuiDB.Scale(-(16 + 84)), 0)
	end
